...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { category: @hotel.category, localization: @hotel.localization, name: @hotel.name, roomlist: @hotel.roomlist }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { category: @hotel.category, localization: @hotel.localization, name: @hotel.name, roomlist: @hotel.roomlist }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
